          ...
          <Row>
            <Col md={12} lg={4}>
              ...
              <List variant='light'>
                ...
                <ListItem id='price_promo' title={`<strong>Promo price:</strong> from ${promoPrice(cost, 0.5)}`} icon='money-bill-wave' />
      ...
      <Grid>
        <Row>
          <Col xs={12}>
            ...
            <OrderForm tripCost={cost} tripDays={days} tripName={name} tripId={otherOptions.id} countryCode={country.alpha3Code}/>
          </Col>
        </Row>
      </Grid>
      <Grid>
